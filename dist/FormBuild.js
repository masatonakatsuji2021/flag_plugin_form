...
class FormBuild {
    ...
    static _setAttribute(targetElement, option, ignores) {
    ...
    static setInput(context, arg1, option) {
        if (!option) {
            option = {};
        }
        let input_;
    ...
    static setTextarea(context, arg1, option) {
        if (!option) {
            option = {};
        }
        let textarea_;
    ...
    static setSelect(context, arg1, values, option) {
        if (!values) {
            values = {};
        }
        if (!option) {
    ...
    static setRadio(context, arg1, values, option) {
        if (!values) {
            values = {};
        }
        if (!option) {
    ...
    static setCheckbox(context, arg1, values, option) {
        if (!values) {
            values = {};
        }
        if (!option) {
    ...
    static setError(context, arg1, message, option) {
        if (!option) {
            option = {};
        }
        let errorElement_;
